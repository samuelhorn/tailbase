<template>
  <div class="container">
    <h1 class="mx-auto text-4xl lg:text-5xl max-w-4xl leading-tight text-center mt-six mb-six font-semibold">Tailwind config generator for a typygraphic scale with vertical rythm</h1>
    ...
    <div class="border rounded-md px-two" :style="'padding-top: '+(baseGrid*2) / 16+'rem; padding-bottom: '+(baseGrid*2) / 16+'rem; background: linear-gradient(180deg, white 0rem, white '+((baseGrid / 16) - .0625)+'rem, transparent '+baseGrid / 16+'rem, white '+baseGrid / 16+'rem); background-size: '+baseGrid / 16+'rem '+baseGrid / 16+'rem; background-repeat: repeat;'">
